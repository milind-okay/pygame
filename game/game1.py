...
bg = pygame.image.load('resources\images\grass.jpeg').convert()
cas = pygame.image.load('resources/images/fb.jpeg').convert_alpha()
arrow = pygame.image.load("resources\images\m1.png").convert_alpha()
bcimg1 = pygame.image.load("resources\images\dc1.png").convert_alpha()
...
blast = pygame.image.load('resources/images/blast.png').convert_alpha()
